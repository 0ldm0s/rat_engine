...
async fn main() -> Result<(), Box<dyn std::error::Error + Send + Sync>> {
    println!("🚀 RAT Engine 双端口模式示例");
    println!("===============================");
    println!("HTTP 端口: https://localhost:3001");
    println!("gRPC 端口: https://localhost:50051");
    println!();
...
<html>
<head>
    <title>RAT Engine 双端口模式</title>
    <meta charset="utf-8">
</head>
<body>
    <h1>🚀 RAT Engine 双端口模式</h1>
    <p>HTTP 服务器运行在端口 3001</p>
    <p>gRPC 服务器运行在端口 50051</p>
    <p>物理隔离：两套完全独立的服务器模块</p>
</body>
</html>
"#,
                )))
    ...
    println!();
    println!("测试方法:");
    println!("  HTTP: curl -k https://localhost:3001/");
    println!("  gRPC: 运行任意 gRPC 客户端示例连接 localhost:50051");
    println!();
    println!("按 Ctrl+C 停止");
